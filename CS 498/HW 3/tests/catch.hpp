...
namespace Catch {
    ...
    #define CATCH_TRAP() __asm__("" : : ) /* NOLINT */
...
#undef S_NORMAL // Dungeon crawl stone soup specific #undef.
                // The name S_NORMAL is used for a shout_type in
                // mon-enum.h (as of December 2019). However, this
                // causes a name collision with a numeric constant in
                // <windows.h>, which is included with catch.hpp in some
                // cases.
